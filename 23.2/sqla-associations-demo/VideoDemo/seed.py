...
d1 = Department(dept_code="mktg", dept_name="Marketing", phone="415-344-9743")
d2 = Department(dept_code="acct", dept_name="Accounting", phone="415-549-1934")
...
alex = Employee(name="Alex Cruz", state="NY", dept_code="mktg")
otis = Employee(name="Otis Winters", state="OR", dept_code="mktg")
diana = Employee(name="Diana Kingston", dept_code="acct")
...
hector = Employee(name="Hector Phoenix", dept_code="it")

db.session.add_all([alex, otis, diana, octavia, larry, kurt, hector])
